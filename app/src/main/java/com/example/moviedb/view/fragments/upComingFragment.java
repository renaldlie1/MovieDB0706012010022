        ...
        public void onChanged(UpComing upComing) {
            ...
            ItemClickSupport.addTo(rv_up_coming).setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
                ...
                public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                    ...
                    bundle.putString("movieOverview" , ""+upComing.getResults().get(position).getOverview());
                    bundle.putString("movieRelease",""+upComing.getResults().get(position).getRelease_date());
                    bundle.putString("movieAvg",""+upComing.getResults().get(position).getVote_average());
                    bundle.putString("moviePop",""+upComing.getResults().get(position).getPopularity());
                    bundle.putString("moviePoster",""+upComing.getResults().get(position).getPoster_path());
                    bundle.putString("movieBackdrop",""+upComing.getResults().get(position).getBackdrop_path());
                    bundle.putString("movieGenre",""+upComing.getResults().get(position).getGenre_ids());
                    bundle.putString("movieId",""+upComing.getResults().get(position).getId());
                    bundle.putString("movieTag",""+upComing.getResults().get(position).getRelease_date());
